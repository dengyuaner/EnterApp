 ...
 */
package com.dy.enter.io;

import android.os.Build;

import com.dy.enter.io.stream.*;
...
public class IOUtils {
    ...
    public static InputStream toBufferedInputStream(InputStream input) throws IOException {
        return com.dy.enter.io.stream.ByteArrayOutputStream.toBufferedInputStream(input);
    }
    ...
    public static byte[] toByteArray(InputStream input) throws IOException {
        com.dy.enter.io.stream.ByteArrayOutputStream output = new com.dy.enter.io.stream.ByteArrayOutputStream();
        copy(input, output);
     ...
     * before using {@link com.dy.enter.io.IOUtils#toByteArray(InputStream, int)} to read into the byte array.
     ...
     * @see com.dy.enter.io.IOUtils#toByteArray(InputStream, int)
     * @since 2.1
     */
